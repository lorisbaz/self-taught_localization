...
if __name__ == "__main__":
    ...
    # select classes that overlap between ilsvrc2012-class and ilsvrc2013-det?
    params.select_subset_overlap_ilsvrc2012_ilsvrc2013 = True
