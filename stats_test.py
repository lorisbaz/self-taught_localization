...
class StatsTest(unittest.TestCase):
    ...
    def test_aggregator(self):
        ...
        self.assertAlmostEqual(stats_aggr.precision[3], 0.4, places = 3)
        ...
        self.assertAlmostEqual(stats_aggr.recall[3], 0.5, places = 3)
        self.assertAlmostEqual(stats_aggr.recall[4], 0.6, places = 3) 
        self.assertAlmostEqual(stats_aggr.detection_rate, 0.6, places = 3) 
        self.assertAlmostEqual(stats_aggr.average_prec, 0.43636363, places = 5) 
