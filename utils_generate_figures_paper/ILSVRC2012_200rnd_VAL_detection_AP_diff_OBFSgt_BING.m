function ILSVRC2012_200rnd_VAL_detection_AP_diff_OBFSgt_BING()
...
avg_prec = mean(sort(OBFSgt.average_precision-BING.average_precision))*100;
legend_string = sprintf('%s\n-minus-\n%s\n(AVG=%.4f)', OBFSgt.legend, BING.legend, avg_prec);
this_legend = plot_detection_graph(sort(OBFSgt.average_precision-BING.average_precision), [1:num_classes], 'o', legend_string, OBFSgt.color);
