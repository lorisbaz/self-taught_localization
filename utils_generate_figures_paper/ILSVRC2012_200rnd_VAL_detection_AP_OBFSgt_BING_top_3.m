function ILSVRC2012_200rnd_VAL_detection_AP_OBFSgt_BING_top_3()
...
avg_prec = mean(sort(BING.average_precision))*100;
this_legend = plot_detection_graph(BING.average_precision(idx2), [1:num_classes], 'o', BING.legend, BING.color);
this_legend = sprintf('%s   mAP = %.2f', this_legend, avg_prec);
h=legend('-DynamicLegend'); set(h,'Interpreter','none');
LEG = cat(1, LEG, this_legend);
