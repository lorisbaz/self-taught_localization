function ILSVRC2012_200rnd_VAL_detection_AP_OBFSgt_SS_top_1()
...
avg_prec = mean(sort(SS.average_precision_top_1))*100;
this_legend = plot_detection_graph(SS.average_precision_top_1(idx2), [1:num_classes], 'o', SS.legend, SS.color);
this_legend = sprintf('%s   mAP = %.2f', this_legend, avg_prec);
h=legend('-DynamicLegend'); set(h,'Interpreter','none');
LEG = cat(1, LEG, this_legend);
