function ILSVRC2012_200rnd_VAL_detection_AP_GT_OBFSgt_top_1()
...
this_legend = plot_detection_graph(OBFSgt.average_precision_top_1(idx), [1:num_classes], 'o', OBFSgt.legend, OBFSgt.color);
this_legend = sprintf('%s   mAP = %.2f', this_legend, avg_prec);
h=legend('-DynamicLegend'); set(h,'Interpreter','none');
LEG = cat(1, LEG, this_legend);
