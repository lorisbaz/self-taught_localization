...
if __name__=='__main__':
    ...
    conf = Configuration(caffe_model='deep_VGG_19')
    params = Params()
...
#                     'fc6', 'fc7', 'fc8', 'prob']
    params.layers = ['data',  'conv1_2', 'conv2_2', \
                     'conv3_4', 'conv4_4', 'pool5',\
                     'fc7']
    ...
    for shard in range(25, 1000):
        ...
        for image_key in image_keys:
            ...
            net.visualize_features(net_features, params.layers, fig1, \
                        subsample_kernels = 8, \
                        dump_image_path = './figure_add_mat_VGG/original' +\
                        image_key)
            fig1.show()
            ...
            net.visualize_features(net_features_obf, params.layers, fig2, \
                        subsample_kernels = 8, \
                        dump_image_path = './figure_add_mat_VGG/obf_obj' +\
