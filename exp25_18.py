...
if __name__ == "__main__":
    ...
    # experiment name
    params.exp_name = 'exp25_18'
    # input
    params.exp_name_input_train = 'exp24_17'
    params.exp_name_input_test = 'exp24_16'
    # categories, splits
    ...
    params.field_name_bboxes = 'PRED:OBFSEARCH_TOPC'
    ...
    if 1:  # -- Anthill
        params.parfun_params_categories = vlg.util.parfun.ParFunAnthillParams( \
                        time_requested=48, memory_requested=8, \
                        progress_bar_params = params.progress_bar_params, \
                        tmp_dir = parfun_tmpdir, max_tasks=200)
    if 0:  # -- Local
