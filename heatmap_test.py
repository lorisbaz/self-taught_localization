...
class NetworkDecafTest(unittest.TestCase):
    ...
    def test_add_val_segment1(self):
        ...
        self.assertAlmostEqual(self.heat.vals_[0,0], 0.30, places=5)
        self.assertEqual(self.heat.vals_[0,1], 0.0)
        self.assertAlmostEqual(self.heat.vals_[0,2], 0.30, places=5)
        ...
        self.assertAlmostEqual(self.heat.vals_[0,0], 0.30+0.30, places=5)
        self.assertEqual(self.heat.vals_[0,1], 0.0)
        self.assertAlmostEqual(self.heat.vals_[0,2], 0.30, places=5)
