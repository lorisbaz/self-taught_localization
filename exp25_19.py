...
if __name__ == "__main__":
    ...
    # experiment name
    params.exp_name = 'exp25_19'
    # input
    params.exp_name_input_train = 'exp24_13'
    params.exp_name_input_test = 'exp24_18'
    # categories, splits
    ...
    params.field_name_pos_bboxes = 'PRED:BING'
    params.field_name_bboxes = 'PRED:BING'
